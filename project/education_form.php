                ...
                <div class="signup-content">
                    <form method="POST" action="process.php" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="institution" placeholder="Institution" />
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="degree" placeholder="Degree" />
                        </div>

                        <div class="form-group">
                            <input type="date" class="form-input" name="graduation_date" placeholder="Graduation Date" />
                        </div>

                        <div class="form-group">
                            <button type="submit" name="save_education">Save
